...
# GeoDCAT profile of STAC collection (Schema)

`ogc.geo.geodcat.geodcat-stac-collection` *v0.1*
...
* YAML version: [schema.yaml](https://ogcincubator.github.io/geodcat-ogcapi-records/build/annotated/geo/geodcat/geodcat-stac-collection/schema.json)
* JSON version: [schema.json](https://ogcincubator.github.io/geodcat-ogcapi-records/build/annotated/geo/geodcat/geodcat-stac-collection/schema.yaml)
...
[context.jsonld](https://ogcincubator.github.io/geodcat-ogcapi-records/build/annotated/geo/geodcat/geodcat-stac-collection/context.jsonld)
...
* Path: `_sources/geodcat-stac-collection`
